                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= ($data['price'] !== null) ? 'Rp ' . number_format(esc($data['price']), 0, ',', '.') : 'Rp 0'; ?> <i class="small"><i style="color: red;">*</i>Package Price is the calculation of package activities and package services</i></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
