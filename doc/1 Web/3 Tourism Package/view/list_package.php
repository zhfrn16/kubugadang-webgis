                            ...
                            <div class="col-auto">
                                <?php if (logged_in()) : ?>
                                    <?php if (in_groups(['admin']) || in_groups(['master'])) : ?>
                                        <button type="button" class="btn btn-primary float-right" disabled><i class="fa-solid fa-plus me-3"></i>Custom New Package</button>
                                    <?php else : ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="card">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="<?= base_url('media/photos/package/' . esc($item['gallery'])); ?>" class="img-fluid rounded-start" alt="Gallery Image" style="object-fit: cover; width: 100%; height: 100%;border-top-right-radius: 0.25rem !important;border-bottom-right-radius: 0.25rem !important;">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
