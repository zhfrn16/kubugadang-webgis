            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <li>If you reserve a homestay, check-out of the homestay still starts at 12.00 noon </li>
                        ...
                        <form id="form">
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="card-body" style="text-align: left;">
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <input type="time" id="time_check_in" name="time_check_in" min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>" class="form-control" required value="10:00">
                                                    ...
                                                    <!-- radio button accomodation type -->
                                                    <div class="form-group">
                                                        <label for="form_accomodation_type" style="color: red;">Homestay Reservation Agreement</label>
                                                        ...
                                                        <script>
                                                            $(document).ready(function() {
                                                                ...
                                                                $('input[name="accomodationType"]').change(function() {
                                                                    if ($('#accomodationType2').is(':checked')) {
                                                                        // If "Custom" is checked, uncheck "Default"
                                                                        $('#accomodationType1').prop('checked', false);
                                                                    }
                                                                });
                                                            });
                                                        </script>
                                                    ...
                                                    <!-- end radio button accomodation type -->
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="row" style="margin:15px;justify-content:center;">
                                            ...
                                            <h4 class="card-title text-center">Homestay</h4>
                                            <!-- </div>
                                            </div> -->
                                            <div class="col-md-3">
                                                <label for="unit_total">Total Unit</label>
                                                <input type="number" id="unit_total" name="unit_total" readonly class="form-control" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="input_days">Total People</label>
                                    ...
                                    <!-- Your Step 2 Form Fields and HTML Here -->
                                    ...
                                    <input type="text" id="total_price_3" name="total_price_3" readonly class="form-control" style="font-weight: bold; color:black; background-color: transparent; border: 0px; width: unset !important; float: right; font-size: larger; text-align: right; margin-top: 12px; " min="1" required>
                                    <input type="number" id="total_price_4" name="total_price_4" readonly hidden class="form-control" style="color:black; background-color: transparent; width: unset !important; float: right; font-size: larger; text-align: right; margin-top: 12px; margin-right: 12px;" min="1" required>
                                ...
                                <fieldset>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body" style="text-align: left;">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="step3_total_price">Total Price Homestay</label>
                                                        <input type="number" id="step3_total_price_homestay" name="step3_total_price_homestay" class="form-control" value="<?= ($edit) ? $datapackage['total_price'] : old('total_price'); ?>" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="step3_total_price">Total Price Reservation</label>
                                                        <input type="number" id="step3_total_price_reservation" name="step3_total_price_reservation" class="form-control" value="<?= ($edit) ? $datapackage['total_price'] : old('total_price'); ?>" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="accordion" id="accordionPanelsStayOpenExample">
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                                                    <div class="accordion-body">
                                                                        <div id="selected-units-info" class="table-responsive"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="card">
                                            <div class="form-group">
                                                ...
                                                <div class="row g-3 align-items-center" style=" justify-content: right;">
                                                    <div class="col-auto">
                                                        <label for="total_total_package" class="col-form-label">Total Homestay:</label>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="text" id="total_total_homestay" class="form-control" readonly style="text-align:right; color: black; background-color: transparent; border: none;">
                                                    </div>
                                                </div>
                                                <div class="row g-3 align-items-center" style=" justify-content: right;">
                                                    <div class="col-auto">
                                    ...
                                    <input type="button" name="final-step" class="final-step" value="Submit" onclick="createReservation()" />
                                    <input type="button" name="previous-step" class="previous-step" value="Previous" />
        ...
        <script>
            $(document).ready(function() {
                ...
                $(".next-step").click(function() {
                    ...
                    // Check if it's the last step, then switch to the "Finish" step
                    if (current === steps - 1) {
...
<script>
    ...
    function calculateCheckOut() {
        ...
        const includeHomestay = <?= json_encode($totaldays); ?>;

        // Misalnya, kita ingin menambahkan 2 hari dari check-in
        const totaldaysToAdd = daysTime - 1; // Ganti dengan durasi yang diinginkan
        if (totaldaysToAdd == 0) {
            daysToAdd = 1;
        } else {
            daysToAdd = totaldaysToAdd;
        }
        const hoursToAdd = 2;
        ...
        if (checkInDate && checkInTime) {
            ...
            if (daysTime == '1' && checkInTime < '18:00:00') {
                ...
                // Logika berdasarkan service Homestay
                if (includeHomestay) {
                    // Logika jika ada service Homestay
                    ...
                    // Logika jika tidak ada service Homestay
                    $('#check_out').val(checkOutDate);
    ...
    function calculateTotalPrice() {
        ...
        if (numberOfPackages !== 0) {
            ...
            // const totalPriceReservation = totalPrice
            // const deposit = totalPriceReservation * 0.2;
            // $('#deposit').val(deposit);
