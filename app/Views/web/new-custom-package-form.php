                    ...
                    <form class="row g-3" action="<?= base_url('web/servicepackage/createservicepackage/') . $id; ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="card-header">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row g-4">
                                            <div class="col-md-12">
                                                ...
                                                <input hidden type="text" id="package_min_capacity" class="form-control" name="package_min_capacity" value="<?= $data['min_capacity'] ?>" required autocomplete="off">
                                                <!-- <br> -->
                                ...
                                <div class="col-md-12">
                                    <p>*Hanya biaya servis yang akan dimasukkan ke dalam harga paket. Non servis tidak.</p>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <!-- <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button> -->
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <!-- <tr>
                                        ...
                                        <td><?= esc($data['min_capacity']); ?> orang <i class="small"><i style="color: red;">*</i>Minimal capacity untuk setiap paket custom adalah 5</i></td>
                                    </tr> -->
                                    <tr>
                                        <td class="fw-bold">Minimal Capacity</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= ($data['price'] !== null) ? 'Rp ' . number_format(esc($data['price']), 0, ',', '.') : 'Rp 0'; ?> <i class="small"><i style="color: red;">*</i>Harga Package adalah kalkulasi dari aktivitas-aktivitas paket dan service</i></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <form action="<?= base_url('web/detailreservation/delete') . '/' . $value['package_id']; ?>" method="post" class="d-inline">
                                                                        ...
                                                                        <input type="hidden" name="package_min_capacity" value="<?= esc($data['min_capacity']); ?>">
