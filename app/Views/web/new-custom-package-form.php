                        ...
                        <div class="col table-responsive">
                            <table class="table table-borderless" style="margin-bottom: 0px;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="fw-bold" style="width:200px">Package Type</td>
                                    ...
                                    <tr>
                                        <td class="fw-bold" style="width:200px">Contact Person</td>
                                        <td><?= esc($data['contact_person']); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold" style="width:200px">Price</td>
                                        <td><?= ($data['price'] !== null) ? 'Rp ' . number_format(esc($data['price']), 0, ',', '.') : 'Rp 0'; ?></td>
                                    </tr>
                                </tbody>
                            </table>
