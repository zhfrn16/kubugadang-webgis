<div class="col-md-auto" style="padding-right: 0px !important; padding-left: 0px !important;">
    ...
    if ($currentURL === '/web' || $currentURL === '/web/' || $currentURL === '/web/explore' || $currentURL === '/web/mypackage') {
    ...
    if ($currentURL === '/web' || $currentURL === '/web/' || $currentURL === '/web/explore' || $currentURL === '/web/mypackage') {
        // Jika URL adalah '/web', tampilkan tombol
        echo '<a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zoom to Kubu Gadang Village" class="btn icon btn-primary mx-1" id="go-to" onclick="zoomToVillageMarkers()">
    ...
    <?php
    $currentURL = $_SERVER['REQUEST_URI'];
    if ($currentURL === '/web/silek') {
        // Jika URL adalah '/web', tampilkan tombol
        echo '<a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zoom to Silek Lanyah" class="btn icon btn-primary mx-1" id="go-to" onclick="zoomToVillageMarkers()">
        <i style="height:1.72rem;width:1.5rem"  class="fa-solid fa-location-arrow"></i>
        </a>';
    }
    ?>
    ...
    <?php
    $currentURL = $_SERVER['REQUEST_URI'];
    if ($currentURL === '/web/event') {
        // Jika URL adalah '/web', tampilkan tombol
        echo '<a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Zoom to Event" class="btn icon btn-primary mx-1" id="go-to" onclick="zoomToVillageMarkers()">
        <i style="height:1.72rem;width:1.5rem"  class="fa-solid fa-location-arrow"></i>
        </a>';
    }
    ?>
    ...
    if ($currentURL === '/web' || $currentURL === '/web/' || $currentURL === '/web/explore' || $currentURL === '/web/mypackage') {
        ...
        <li>
            ...
            <li>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="check-oev" value="ev" onchange="checkObject()">
                    <label class="form-check-label" for="check-oev">Events</label>
                </div>
            </li>
            <li>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="check-ofc" value="fc" onchange="checkObject()">
                    <label class="form-check-label" for="check-ofc">Facilities</label>
                </div>
            </li>
        </ul>
