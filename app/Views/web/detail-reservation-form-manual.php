...
<section class="section">
                        ...
                        <table class="col-12">
                            <tbody>
                                <tr>
                                    ...
                                    <?php if ($detail['deposit_check'] == null || $detail['proof_of_deposit'] == null) : ?>
    ...
    <?php if ($datenow < $batasdp && $detail['proof_of_payment'] != null && $detail['cancel'] != 1 && $detail['deposit_check'] == 1 && $detail['payment_check'] == 1) : ?>
        <br>
    ...
    <?php if ($datenow > $batasdp && $datenow < $detail['check_in'] && $detail['proof_of_payment'] != null && $detail['cancel'] != 1 && $detail['deposit_check'] == 1 && $detail['payment_check'] == 1) : ?>
        <br>
    ...
    <tr>
        <td>
            <!-- upload proof refund -->
            <?php if ($detail['status'] == 1 && $detail['proof_of_deposit'] != null && $detail['proof_of_payment'] == null && $detail['cancel'] != 1 && $batasdp > $datenow && $detail['deposit_check'] == 1) : ?>
            ...
            <div class="modal-body">
                <div class="card-header">
                    <form class="row g-4" action="<?= base_url('web/detailreservation/saverefund/') . $detail['id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php elseif ($detail['proof_of_payment'] != null) : ?>
