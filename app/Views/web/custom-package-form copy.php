                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="form-select" name="day" id="day" required onchange="activityOptions()">
                                            ...
                                            <?php if (!empty($activitiesForDay)) :  ?>
                                                <?php foreach ($activitiesForDay as $index => $currentActivity) : ?>
                                                    ...
                                                    <?php if ($currentActivity['day'] === $d['day']) : ?>
                                                        ...
                                                        ?>
                                                        <li><button type="button" onclick="routeBetweenObjects( <?= $currentActivity['lat'] ?>, <?= $currentActivity['lng'] ?>, <?= $nextActivity['lat'] ?>, <?= $nextActivity['lng'] ?>); addOnly<?= $d['day'], $d['package_id']; ?>();" class="btn btn-outline-primary"><i class="fa fa-road"></i> Activity <?= esc($currentActivity['activity']); ?> ke <?= esc($nextActivity['activity']); ?></button></li>
