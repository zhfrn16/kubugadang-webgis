                ...
                <div col="auto ">
                    <div class="btn-group float-end" role="group">
                        ...
                        <form action="<?= base_url('web/package/deletepackage') . '/' . $data['id']; ?>" method="post" id="formcancel" class="d-inline">
                            ...
                            <button style="border-radius: 0px;" type="button" class="btn btn-danger" onclick="return showconfirmcancelbooking();"><i class="fa fa-times"></i>Cancel Extend This Package</button>
                        </form>
                    </div>
                </div>
                                            ...
                                            <div class="col-sm-2 ">
                                                <div class="btn-group float-end" role="group" aria-label="Basic example">
                                                    ...
                                                    <form action="<?= base_url('web/detailreservation/updateday') . '/' . $key['package_id']; ?>" method="post" class="d-inline">
                                                        ...
                                                        <?php if ($key['status'] == '0') : ?>
                                                            <button disabled type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editdayModal<?= esc($key['day']) ?>"><i class="fa fa-pencil"></i></button>
                                                        <?php else : ?>
                                                    ...
                                                    <form action="<?= base_url('web/detailreservation/deleteday') . '/' . $key['package_id']; ?>" method="post" class="d-inline">
                                                        ...
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <?php if ($key['status'] == '0') : ?>
                                                            <button disabled type="submit" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?');"><i class="fa fa-times"></i></button>
                                                        <?php else : ?>
