                                                            ...
                                                            <?php if ($item['cancel'] == '0') : ?>
                                                                <?php if ($item['type_of_payment'] == '1') : ?>
                                                                    <?php if ($item['proof_of_deposit'] == null) : ?>
                                                                        <!-- <div class="d-inline-flex align-items-center active" style="background-color: #E3F2FD; color: #000; font-weight: 600; padding: 1px 10px; border-radius: 15px; font-size: 0.9rem;">
                                                                            <div style="background-color: #1976D2; width: 9px; height: 9px; border-radius: 50%; margin-right: 10px;"></div>
                                                                            <div>Pay deposit!</div>
                                                                        </div> -->
                                                                        ...
                                                                        <?php elseif ($item['payment_check'] == 1) : ?>
                                                                            ...
                                                                            <?php if ($item['review'] == null) : ?>
                                                                                ...
                                                                                <?php elseif ($datenow < $item['check_out']) : ?>
                                                                                    <!-- <div class="d-inline-flex align-items-center active" style="background-color: #E0E0E0; color: #000; font-weight: 600; padding: 1px 10px; border-radius: 15px; font-size: 0.9rem;">
                                                                                        <div style="background-color: #212121; width: 9px; height: 9px; border-radius: 50%; margin-right: 10px;"></div>
                                                                                        <div>Enjoy trip!</div>
                                                                                    </div> -->
