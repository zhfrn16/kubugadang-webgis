        ...
        <div class="col-md-4 col-12">
            <div class="row">
                ...
                <div class="col-12" id="list-rg-col">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title text-center">List Object Tourism</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody id="table-data">
                                        <?php if (isset($objects)) : ?>
                                            ...
                                            <?php foreach ($objects as $item) : ?>
                                                <tr>
                                                    <script>
                                                        objectMarker("<?= esc($item['id']); ?>", <?= esc($item['lat'] ?? 0); ?>, <?= esc($item['lng'] ?? 0); ?>);
                                                    </script>
                                                    <td><?= esc($i); ?></td>
                                                    <td><?= esc($item['name']); ?></td>
                                                    <td>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info" class="btn icon btn-primary mx-1" href="<?= base_url('dashboard/objecttourism/' . $item['id']); ?>">
