                ...
                <div class="card-body">
                    ...
                    <div class="col-auto ">
                        ...
                        <div class="btn-group float-right" role="group">
                            <button type="button" class="btn btn-outline-primary " data-bs-toggle="modal" data-bs-target="#unitRumahGadangModal" data-bs-whatever="@getbootstrap"><i class="fa fa-plus"></i> Add Unit Homestay</button>
                            <button type="button" class="btn btn-outline-info " data-bs-toggle="modal" data-bs-target="#facilityUnitModal" data-bs-whatever="@getbootstrap"><i class="fa fa-plus"></i> Add Facility Unit</button>
                            <button type="button" class="btn btn-outline-secondary " data-bs-toggle="modal" data-bs-target="#facilityModal" data-bs-whatever="@getbootstrap"><i class="fa fa-plus"></i> New Facility</button>
                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <select class="form-select" name="unit_homestay" id="unit_homestay" required>
                                                            ...
                                                            <?php foreach ($unit as $item => $keyy) : ?>
                                                                ...
                                                                <option value="<?= esc($keyy['homestay_id']); ?>-<?= esc($keyy['unit_type']); ?>-<?= esc($keyy['unit_number']); ?>">[<?= esc($keyy['name_type']); ?>] <?= esc($keyy['unit_name']); ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div><br>
                                    ...
                                    <div class="card border border-primary-subtle p-2 mb-2">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                ...
                                                Capacity : <?= esc($itemunit['capacity']); ?> person <br>
                                            ...
                                            <div class="btn-group float-end" role="group" aria-label="Basic example">
                                                <!-- Modal Edit Unit-->
                                                <!-- Modal Edit Unit -->
                                                <div class="modal fade" id="editUnitRumahGadangModal<?= esc($itemunit['unit_number']) ?><?= esc($itemunit['unit_type']) ?>" tabindex="-1" aria-labelledby="editUnitRumahGadangModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="editUnitRumahGadangModalLabel">Edit Unit Homestay</h1>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="row g-4">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <select class="form-select" id="unit_type" name="editunit_type" required>
                                                                            ...
                                                                            <div class="col-md-5">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="editNama_unit" name="editNama_unit" value="<?= esc($itemunit['unit_name']); ?>" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row g-4">
                                                                            <div class="col-md-5">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number" class="form-control" id="editCapacity" name="editCapacity" value="<?= esc($itemunit['capacity']); ?>" min="1" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-7">
                                                                                <div class="form-group">
                                                                                    <label for="editPrice">Price</label>
                                                                                    <input type="number" class="form-control" id="editPrice" name="editPrice" value="<?= esc($itemunit['price']); ?>" min="0" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row g-4">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea name="editDescription" id="editDescription" class="form-control" cols="30" rows="3" required><?= esc($itemunit['description']); ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group mb-4">
