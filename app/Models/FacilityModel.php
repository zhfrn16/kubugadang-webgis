...
class FacilityModel extends Model
{
    ...
    public function get_list_facility()
    {
        ...
        $columns = "{$this->table}.id,{$this->table}.name,{$this->table}.price,{$this->table}.category,{$this->table}.min_capacity,{$this->table}.type_id";
    ...
    {
        $coords = "ST_Y(ST_Centroid({$this->table}.geom)) AS lat, ST_X(ST_Centroid({$this->table}.geom)) AS lng";
        $columns = "{$this->table}.id,{$this->table}.name,{$this->table}.type_id,{$this->table}.price";
